...
public final class Constants {
    ...
    static final String PROP_DEVICE = "ro.product.vendor.device";
    static final String PROP_MODEL = "ro.product.vendor.model";
    static final String DOWNLOAD_WEBPAGE_URL = "";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "SystemUpdates/";
    public static  String fileName = "";
    public static  String donationbitmap = "";
    public static  String maintainer = "";
    public static  String maintainer_url = "";
    public static  String whatnew = "";
    public static String advisory = "";
    public static String postlink = "";
    public static String avatarbitmap = "";
    public static String isdownloadable = "";
    public static String historychglog = "";
}
